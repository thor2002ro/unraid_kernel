...
static volatile unsigned long cpu_start_stop_jiffies;
...
static int smp_boot_one_cpu(int cpuid, struct task_struct *idle)
{
	...
	*/
	...
	cpu_start_stop_jiffies = jiffies + msecs_to_jiffies(8000);
...
int __cpu_up(unsigned int cpu, struct task_struct *tidle)
{
	...
	if (cpu_start_stop_jiffies != 0 &&
		time_before(jiffies, cpu_start_stop_jiffies))
		return -EDEADLOCK;
...
int __cpu_disable(void)
{
	...
	/* when was this CPU stopped? */
	cpu_start_stop_jiffies = jiffies;
